...
buy the stock at 1 dollar, and sell at 8 dollars, and then buy it at 4 dollars and sell it
at 10 dollars. Since we did two transactions, there is a 4 dollar fee, so we have 7 + 6 = 13
...
print(max_profit_with_fee([1, 3, 2, 8, 4, 10], 2))
